...
export default function Chatbot() {
    ...
    return (
        <>
            <button
                className="fixed my-5 bottom-4 right-4 inline-flex items-center justify-center text-sm font-medium disabled:pointer-events-none disabled:opacity-50 border rounded-full w-16 h-16 bg-black hover:bg-gray-700 m-0 cursor-pointer border-gray-200 bg-none p-0 normal-case leading-5 hover:text-gray-900"
            ...
            <div style={{ boxShadow: "0 0 #0000, 0 0 #0000, 0 1px 2px 0 rgb(0 0 0 / 0.05)" }}
                className={`fixed bottom-[calc(4rem+1.5rem)] right-0 mx-2.5 bg-white p-6 rounded-lg border border-[#e5e7eb] w-[300px] h-[350px] ${visible ? 'block' : 'hidden'}`}>

                {/* <!-- Heading --> */}
                <div className="flex flex-col space-y-1.5 pb-6">
                    <h2 className="font-semibold text-lg tracking-tight">Liên hệ</h2>
                </div>

                <div className="pr-4 h-[474px] min-w-full display-table">
